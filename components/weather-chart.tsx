...
const WeatherChart: React.FC<WeatherChartProps> = React.memo(({ result }) => {
  ...
  return (
    <Card className="my-2 py-0 shadow-none bg-white dark:bg-neutral-900 card-surface border-neutral-200 dark:border-neutral-800 gap-0">
                ...
                <div className="max-h-[300px] overflow-y-auto scrollbar-thin scrollbar-thumb-neutral-300 dark:scrollbar-thumb-neutral-700 scrollbar-track-transparent pr-1">
                  <div className="space-y-2">
                    {dailyForecast.map((day: ProcessedDailyForecast, index: number) => (
                      <div
                        key={day.timestamp}
                        className="flex items-center justify-between p-2 rounded-lg bg-white dark:bg-neutral-900 card-surface border border-neutral-200 dark:border-neutral-800"
                      >
            ...
            <div className="mb-3">
              {airPollution ? (
                <div className="space-y-4">
                  ...
                  <div className="rounded-lg border border-neutral-200 dark:border-neutral-800 bg-white dark:bg-neutral-900 card-surface p-4">
