...
export const PostMessageUpgradeDialog = React.memo(
  ({ open: _open, onOpenChange: _onOpenChange }: PostMessageUpgradeDialogProps) => null,
);
      ...
      >
        <DialogHeader className="p-0">
          <div className="relative h-40 sm:h-48 overflow-hidden rounded-t-lg">
            <Image
              src="/signals-promo.png"
              alt="Bored Brain Signals"
              width={1200}
              height={630}
            ...
            <div className="absolute bottom-4 left-4 right-4">
              ...
              <DialogTitle className="text-white text-xl sm:text-2xl font-bold tracking-tight">
                Introducing Bored Brain Signals
              </DialogTitle>
  ...
  ({
    ...
    return (
      <>
        ...
        {/* Post-Message Upgrade Dialog intentionally disabled while subscriptions are paused */}
