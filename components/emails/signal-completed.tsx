        ...
        <Body className="bg-white font-sans py-[40px]">
          <Container className="max-w-[560px] mx-auto px-[24px] py-[48px] bg-[#FFFFFF] border border-solid border-neutral-300 rounded-lg my-[24px]">
            <Section className="text-center mb-6">
              <Img src="https://boredbrain.app/icon.png" alt="Bored Brain" className="w-[48px] h-[48px] mx-auto mb-[24px]" />
              <Text className="text-[24px] font-semibold text-[#020304] mb-[16px] m-0">Daily Signal Complete</Text>
            ...
            <Section className="text-center mb-[40px]">
              <Button
                href={`https://boredbrain.app/search/${props.chatId}`}
            ...
            <Section className="text-center border-t border-solid border-black/30 pt-[32px]">
              <Img src="https://boredbrain.app/icon.png" alt="Bored Brain" className="w-[32px] h-[32px] mx-auto mb-[16px]" />
              <Text className="text-[14px] text-[#6B7280] m-0">
                Bored Brain •{' '}
                <a href="https://boredbrain.app" className="text-[#6B7280] no-underline">
                  boredbrain.app
                </a>
              </Text>
            </Section>
