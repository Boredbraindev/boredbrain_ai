...
const YouTubeCard: React.FC<YouTubeCardProps> = ({ video, index }) => {
  ...
  return (
    <div
      className="w-[280px] h-[350px] rounded-lg border dark:border-neutral-800 border-neutral-200 overflow-hidden bg-white dark:bg-neutral-900 card-surface shadow-xs hover:shadow-md transition-shadow duration-200 relative mr-4"
...
const YouTubeEmptyState: React.FC = () => (
  <div className="rounded-xl overflow-hidden border dark:border-neutral-800 border-neutral-200 bg-white dark:bg-neutral-900 card-surface shadow-xs p-4 text-center">
  ...
  return (
    <div className="w-full my-4">
      <Accordion type="single" collapsible defaultValue="videos">
        <AccordionItem
          value="videos"
          className="border dark:border-neutral-800 rounded-xl bg-white dark:bg-neutral-900 card-surface shadow-xs"
        >
