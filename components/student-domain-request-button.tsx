...
`
    : ''
}I am a current student at this university and would love to access the student discount for Bored Brain Pro.
...
Best regards`;
  ...
  const handleSubmit = () => {
    ...
    const mailtoLink = `mailto:hello@boredbrain.app?subject=${encodeURIComponent(subject)}&body=${formattedBody}`;
