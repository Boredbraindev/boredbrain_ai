...
export const NearbySearchSkeleton = ({ type }: { type: string }) => {
  return (
    <div className="relative w-full h-[70vh] bg-white dark:bg-neutral-900 card-surface rounded-lg overflow-hidden border border-neutral-200 dark:border-neutral-800 my-4">
      {/* Header skeleton */}
      ...
      <div className="w-full h-full flex flex-col">
        ...
        {/* List preview area */}
        <div className="h-[38%] bg-white dark:bg-neutral-900 card-surface border-t border-neutral-200 dark:border-neutral-800 px-4 sm:px-6 py-3 overflow-hidden">
...
export function CodeInterpreterView({
  ...
  return (
    <div className="group overflow-hidden bg-white dark:bg-neutral-900 card-surface rounded-lg border border-neutral-200 dark:border-neutral-800 shadow-sm transition-all duration-200 hover:shadow">
      {/* Header */}
