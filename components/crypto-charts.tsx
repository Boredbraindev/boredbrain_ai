...
const CustomTooltip = ({ active, payload, label }: any) => {
  if (active && payload && payload.length) {
    ...
    if (data && data.openClose) {
      // Candlestick tooltip
      return (
        <div className="bg-white dark:bg-neutral-900 card-surface border border-neutral-200 dark:border-neutral-700 rounded-lg p-3 shadow-sm max-w-[200px] z-50">
      ...
      return (
        <div className="bg-white dark:bg-neutral-900 card-surface border border-neutral-200 dark:border-neutral-700 rounded-lg p-2 shadow-sm max-w-[150px] z-50">
...
const CryptoChart: React.FC<CryptoChartProps> = memo(({ result, coinId, chartType = 'line' }) => {
  ...
  return (
    <Card className="w-full my-6 border border-border/40 bg-muted/10 backdrop-blur-sm rounded-2xl shadow-none">
                ...
                <div className="flex items-center gap-2 mb-2">
                  ...
                  {url && (
                    <Button
                      ...
                      size="sm"
                      asChild
                      className="h-6 px-2 flex-shrink-0 rounded-full text-primary hover:text-primary-foreground hover:bg-primary/20"
                    >
                      <Link href={url} target="_blank">
                        <ArrowUpRight className="h-3 w-3" />
                      </Link>
                ...
                {marketData && (
                  <div className="grid grid-cols-2 sm:grid-cols-4 gap-3 text-xs text-muted-foreground">
                    ...
                    {marketData.total_volume?.usd && (
                      <div>
                        <div className="opacity-70">24h Volume</div>
                        <div className="font-semibold text-foreground">
                    ...
                    {marketData.circulating_supply && (
                      <div>
                        <div className="opacity-70">Circulating</div>
                        <div className="font-semibold text-foreground">
