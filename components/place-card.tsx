...
const PlaceCard: React.FC<PlaceCardProps> = ({
  ...
  if (isOverlay) {
    return (
      <div
        className={cn(
          'bg-white dark:bg-neutral-900 card-surface border border-neutral-200 dark:border-neutral-800 rounded-2xl p-3 sm:p-4 w-full',
          className,
        )}
        onClick={onClick}
      >
  ...
  return (
    <div
      onClick={onClick}
      className={cn(
        'w-full p-4 max-sm:p-3 cursor-pointer transition-colors border border-neutral-200 dark:border-neutral-800 rounded-2xl bg-white dark:bg-neutral-900 card-surface',
