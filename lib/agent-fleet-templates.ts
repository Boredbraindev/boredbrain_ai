...
const TRADING_AGENTS = makeAgents('trading', [
  ...
  { name: 'Options Flow Scanner', desc: 'Tracks unusual options activity on Deribit and identifies smart money bets.', toolCats: ['crypto', 'data', 'finance'], price: 50 },
...
const GAMING_AGENTS = makeAgents('gaming', [
  ...
  { name: 'Esports Crypto Bot', desc: 'Tracks esports crypto betting markets and tournament prize pools.', toolCats: ['search', 'data', 'social'], price: 25 },
