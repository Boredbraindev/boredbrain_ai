...
export function getMessageByErrorCode(errorCode: ErrorCode): string {
  ...
  switch (errorCode) {
    ...
    case 'rate_limit:api':
      return 'You have reached your daily limit for this feature. Please try again tomorrow while open access continues.';
    ...
    case 'upgrade_required:auth':
      return 'This feature is currently restricted. We will reopen access when premium plans return.';

    case 'rate_limit:chat':
      return 'You have exceeded your maximum number of messages for the day. Please try again later.';
    case 'upgrade_required:chat':
      return 'You have reached your daily search limit. Please try again tomorrow.';
    case 'not_found:chat':
    ...
    case 'forbidden:model':
      return 'This AI model is restricted during open access.';
    case 'model_restricted:model':
      return 'Access to this AI model is temporarily limited.';
    case 'upgrade_required:model':
      return 'This premium AI model is currently disabled while subscriptions are paused.';
    case 'rate_limit:model':
      return 'You have reached the usage limit for this AI model. Please try again tomorrow.';
...
export function getErrorActions(error: ChatSDKError): {
  ...
  if (isProRequired(error)) {
    return {
      primary: { label: 'Learn About Limits', action: 'upgrade' },
