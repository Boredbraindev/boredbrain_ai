...
const MOCK_NETWORK = {
  ...
  nodes: [
    ...
    { id: 'node-bb-trader', name: 'BB Trading Agent', platform: 'boredbrain', endpoint: 'https://api.boredbrain.app/v1/trader', agentCardUrl: '/.well-known/agent-card.json', capabilities: ['Market Advising', 'Technical Analysis'], tools: ['coin_data', 'stock_chart'], status: 'online', lastSeen: new Date(Date.now() - 30000).toISOString(), latency: 95, totalInteractions: 29, trustScore: 94, chain: 'arbitrum', walletAddress: '0xabcdef1234567890abcdef1234567890abcdef34' },
