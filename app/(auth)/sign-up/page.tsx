  ...
  const handleEmailSignUp = async (e: FormEvent) => {
    ...
    try {
      ...
      if (result.error) {
        ...
        // Better Auth with autoSignIn will log them in automatically
      ...
      <div className="w-full max-w-[400px] space-y-8">
        ...
        <div className="flex flex-col items-center gap-4">
          ...
          <div className="text-center space-y-1">
            ...
            <p className="text-sm text-muted-foreground">Get started with BoredBrain today</p>
          </div>
        </div>
        ...
        <form onSubmit={handleEmailSignUp} className="space-y-4">
          ...
          <div className="flex items-start gap-3 pt-1">
            <input
              ...
              className="mt-0.5 h-4 w-4 rounded border-border/50 bg-background/50 accent-primary"
            />
          ...
          <>
            <div className="relative">
              ...
              <div className="relative flex justify-center text-xs">
                <span className="bg-background px-3 text-muted-foreground/60">or sign up with</span>
              </div>
            </div>
