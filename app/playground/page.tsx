...
const PROVIDERS: Provider[] = [
  // ── Anthropic ───────────────────────────────────────────────────────────
  {
    ...
    pricing: '$0.003/1K',
    pricePer1k: 0.003,
    models: ['Claude 4 Sonnet', 'Claude 3.5 Sonnet', 'Claude 3 Opus', 'Claude 3 Haiku'],
    defaultModel: 'Claude 3.5 Sonnet',
    speed: 4,
    costRating: 4,
    specialty: 'Safety-first reasoning & long context',
    description: 'Industry-leading safety alignment with 200K context (~90 tok/s)',
  },
  // ── OpenAI ──────────────────────────────────────────────────────────────
  {
    id: 'openai',
    ...
    speed: 4,
    costRating: 4,
    specialty: 'General-purpose intelligence & tool use',
    description: 'Versatile models with strong function calling (~100 tok/s)',
  },
  // ── Google / Gemini ─────────────────────────────────────────────────────
  {
    id: 'gemini',
    ...
    pricing: 'Free 15 RPM',
    pricePer1k: 0,
    models: ['Gemini 2.5 Pro', 'Gemini 2.0 Flash', 'Gemini 1.5 Pro', 'Gemma 2 27B'],
    defaultModel: 'Gemini 2.0 Flash',
    speed: 4,
    costRating: 1,
    specialty: 'Multimodal & free tier',
    description: 'Google multimodal with 1M context and generous free tier (~120 tok/s)',
  },
  // ── Mistral ─────────────────────────────────────────────────────────────
  {
    id: 'mistral',
    ...
    pricing: '$0.002/1K',
    pricePer1k: 0.002,
    models: ['Mistral Large', 'Mistral Medium', 'Mistral Small', 'Codestral', 'Mixtral 8x22B', 'Pixtral'],
    defaultModel: 'Mistral Large',
    speed: 4,
    costRating: 3,
    specialty: 'European AI with strong multilingual & code',
    description: 'High-performance open-weight models from Paris (~110 tok/s)',
  },
  // ── xAI ─────────────────────────────────────────────────────────────────
  {
    id: 'xai',
    ...
    speed: 4,
    costRating: 3,
    specialty: 'Real-time web knowledge & wit',
    description: 'Real-time X/web access with unfiltered personality (~95 tok/s)',
  },
  // ── Meta / Llama ────────────────────────────────────────────────────────
  {
    id: 'meta',
    ...
    pricing: '$0.0008/1K',
    pricePer1k: 0.0008,
    models: ['Llama 4 Maverick', 'Llama 4 Scout', 'Llama 3.1 405B', 'Llama 3.2 90B Vision', 'Llama 3.2 11B'],
    defaultModel: 'Llama 4 Scout',
    speed: 3,
    costRating: 2,
    specialty: 'Open-source foundation models',
    description: 'State-of-the-art open-weight models for any use case (~85 tok/s)',
  },
  // ── DeepSeek ────────────────────────────────────────────────────────────
  {
    id: 'deepseek',
  ...
  // ── Cohere ──────────────────────────────────────────────────────────────
  {
    ...
    speed: 4,
    costRating: 2,
    specialty: 'Enterprise RAG & search-grounded generation',
    description: 'Built for enterprise retrieval-augmented generation (~100 tok/s)',
  },
  // ── Qwen ────────────────────────────────────────────────────────────────
  {
    id: 'qwen',
    ...
    pricing: '$0.0004/1K',
    pricePer1k: 0.0004,
    models: ['Qwen2.5-72B', 'Qwen2.5-Coder-32B', 'QwQ-32B'],
    defaultModel: 'Qwen2.5-72B',
    speed: 3,
    costRating: 1,
    specialty: 'Multilingual & code with strong Chinese support',
    description: 'Top-tier open-weight from Alibaba Cloud (~90 tok/s)',
  },
  // ── Perplexity ──────────────────────────────────────────────────────────
  {
    id: 'perplexity',
    ...
    pricing: '$0.001/1K',
    pricePer1k: 0.001,
    models: ['Sonar Huge', 'Sonar Large', 'Sonar Small'],
    defaultModel: 'Sonar Large',
    speed: 3,
    costRating: 2,
    specialty: 'Search-grounded answers with citations',
    description: 'Real-time web search integrated into every response (~70 tok/s)',
  },
  // ── Groq ────────────────────────────────────────────────────────────────
  {
    id: 'groq',
  ...
  // ── Yi ──────────────────────────────────────────────────────────────────
  {
    ...
    pricing: '$0.0003/1K',
    pricePer1k: 0.0003,
    models: ['Yi-Lightning', 'Yi-Large', 'Yi-34B-Chat'],
    defaultModel: 'Yi-Large',
    speed: 4,
    costRating: 1,
    specialty: 'Bilingual Chinese-English powerhouse',
    description: 'High-performance bilingual models from 01.AI (~95 tok/s)',
  },
  // ── Databricks ──────────────────────────────────────────────────────────
  {
    id: 'databricks',
    ...
    defaultModel: 'DBRX-Instruct',
    speed: 3,
    costRating: 2,
    specialty: 'Enterprise data & analytics',
    description: 'MoE architecture optimized for enterprise workloads (~75 tok/s)',
  },
  // ── Stability AI ────────────────────────────────────────────────────────
  {
    id: 'stability',
    ...
    pricing: '$0.0001/1K',
    pricePer1k: 0.0001,
    models: ['StableLM 2', 'Stable Code 3B'],
    defaultModel: 'StableLM 2',
    speed: 4,
    costRating: 1,
    specialty: 'Lightweight on-device models',
    description: 'Compact models for edge and on-device deployment (~120 tok/s)',
  },
  // ── OpenRouter ──────────────────────────────────────────────────────────
  {
    id: 'openrouter',
