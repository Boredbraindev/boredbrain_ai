        ...
        <div className="flex-1 flex items-center justify-center px-4 sm:px-6 lg:px-8">
          <Card className="max-w-md w-full text-center shadow-none">
            <CardHeader className="pb-4">
              ...
              <CardDescription>
                Signals scheduling is temporarily disabled while the Telegram mini app remains open access. We&apos;ll
                re-enable advanced automation once subscriptions return.
              </CardDescription>
            </CardHeader>
            <CardContent className="space-y-4">
              <div className="bg-muted/50 rounded-lg p-4 space-y-2">
                ...
                <div className="flex items-center gap-2 text-sm">
                  ...
                  <span>Up to 10 active signals</span>
                </div>
              </div>
