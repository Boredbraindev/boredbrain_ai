...
const warningConfig = {
  'total-limit': {
    icon: Alert02Icon,
    message: "You've reached the maximum of 10 signals. Delete existing signals to create new ones.",
  },
  'daily-limit': {
    icon: AlarmClockIcon,
    message:
      "You've reached the maximum of 5 active daily signals. Pause or delete existing daily signals to create new ones.",
  },
  custom: {
    icon: Alert02Icon,
    message: '',
...
export function WarningCard({ type, icon, message, className = '' }: WarningCardProps) {
  ...
  return (
    <Card
      className={`mb-6 border-orange-200 bg-orange-50 dark:border-orange-900 dark:bg-orange-950/20 shadow-none rounded-2xl ${className}`}
    >
